...
if __name__ == '__main__':
    ...
    if _api_manager.login(_ADDON.getSetting("username"), _ADDON.getSetting("password")) is False:
        response = xbmcgui.Dialog().yesno('Login Data not valid', 'Your Login Data is invalid.', 'Please enter Login Data in Settings!',nolabel='Exit', yeslabel='Settings')
